# sample-ds - Decision Service

This repository contains the `sample-ds decision service`, packaged as a `Quarkus Microservice JAR)`, and was originally generated by the custom `Decision Service Maven Archetype` in order to ensure compliancee with Maven best practices. 
